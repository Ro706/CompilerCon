...
{
       2,     3,     4,     4,    12,    13,     9,     0,     5,     5,
       8,    16,    17,    18,    19,    10,    11,    12,    13,     0,
       0,    15,    10,    11,    12,    13,    14
};
...
{
       0,    12,     0,     1,     3,     9,    13,    14,     8,    14,
       4,     5,     6,     7,     8,    10,    14,    14,    14,    14
};
...
#line 24 "cal105.y"
                        { if (yyvsp[0] == 0) { printf("Error: Division by zero!\n"); yyval = 0; } else yyval = yyvsp[-2] / yyvsp[0]; }
#line 1148 "y.tab.c"
    break;
