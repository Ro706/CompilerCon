...
## Practical :
`1)Theory assignment for writing details about LEX and YACC compilation.`
`2) Count the number of comments, keywords, identifiers, words, lines and spaces from input file.`
